...
class ResNet18Head40TOMLDirectionUnifiedStem533(nn.Module):
    """Head40 3D ResNet18 with a 5x3x3 direction-aware stem."""
...
def resnet18_3d(
    ...
    return ResNet18Head40TOMLDirectionUnifiedStem533(
