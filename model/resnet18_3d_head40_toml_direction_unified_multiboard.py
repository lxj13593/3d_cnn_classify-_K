...
class ResNet18Head40TOMLDirectionUnified(nn.Module):
    """Head40 3D ResNet18 for inputs standardized to the high-D head side."""
...
) -> ResNet18Head40TOMLDirectionUnified:
    return ResNet18Head40TOMLDirectionUnified(
...
def architecture_metadata() -> dict[str, object]:
    return {
        "model": "ResNet18Head40TOMLDirectionUnified",
        "block": "BasicBlock3D",
        "layers": [2, 2, 2, 2],
