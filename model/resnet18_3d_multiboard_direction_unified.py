...
class ResNet18DirectionUnified(nn.Module):
    """Full-volume 3D ResNet18 for inputs standardized to the high-D head side."""
...
) -> ResNet18DirectionUnified:
    return ResNet18DirectionUnified(
...
def architecture_metadata() -> dict[str, object]:
    return {
        "model": "ResNet18DirectionUnified",
        "block": "BasicBlock3D",
        "layers": [2, 2, 2, 2],
