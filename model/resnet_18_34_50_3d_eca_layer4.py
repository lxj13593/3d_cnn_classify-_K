...
class ResNet3D(nn.Module):
    def __init__(self, block, layers, num_classes=2, dropout_rate=0.5):
        ...
        self.layer3 = self._make_layer(block, 256, layers[2], stride=2, use_eca=False)
...
def resnet18_3d(num_classes=2):
    """Constructs a ResNet-18 3D model with ECA attention in layer4."""
    model = ResNet3D(BasicBlock, [2, 2, 2, 2], num_classes=num_classes)
    return model


def resnet34_3d(num_classes=2):
    """Constructs a ResNet-34 3D model with ECA attention in layer4."""
    model = ResNet3D(BasicBlock, [3, 4, 6, 3], num_classes=num_classes)
    return model


def resnet50_3d(num_classes=2):
    """Constructs a ResNet-50 3D model with ECA attention in layer4."""
