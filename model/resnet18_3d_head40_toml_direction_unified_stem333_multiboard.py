...
class ResNet18Head40TOMLDirectionUnifiedStem333(nn.Module):
    """Head40 3D ResNet18 with a local isotropic 3x3x3 stem."""
...
def resnet18_3d(
    ...
    return ResNet18Head40TOMLDirectionUnifiedStem333(
...
def architecture_metadata() -> dict[str, object]:
    return {
        "model": "ResNet18Head40TOMLDirectionUnifiedStem333",
        "block": "BasicBlock3D",
        "layers": [2, 2, 2, 2],
