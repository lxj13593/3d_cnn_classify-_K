...
class ResNet3D(nn.Module):
    def __init__(self, block, layers, num_classes=2, dropout_rate=0.5):
        ...
        # Head-region input depth is 37, so keep depth resolution in the stem.
        ...
        # Shape schedule for [B, 1, 37, 37, 37]:
        # stem/layer1: 37x37x37 -> layer2: 19x19x19
        # -> layer3: 10x10x10 -> layer4: 5x5x5.
...
if __name__ == "__main__":
    ...
    input_tensor = torch.randn(1, 1, 37, 37, 37)
