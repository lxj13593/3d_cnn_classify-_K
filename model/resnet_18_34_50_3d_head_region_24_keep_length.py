...
class ResNet3D(nn.Module):
    def __init__(self, block, layers, num_classes=2, dropout_rate=0.5):
        ...
        # Head-region input depth is 24, so keep depth resolution in the stem.
        ...
        # Shape schedule for [B, 1, 24, 37, 37]:
        # stem/layer1: 24x37x37 -> layer2: 12x19x19
        # -> layer3: 6x10x10 -> layer4: 6x5x5.
        ...
        # Keep D at 6 in layer4 while H/W continue downsampling to 5x5.
...
if __name__ == "__main__":
    ...
    input_tensor = torch.randn(1, 1, 24, 37, 37)
