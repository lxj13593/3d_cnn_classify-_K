...
class ResNet18Head40TOMLDirectionUnifiedStem533AmbiguousWeight00(nn.Module):
    """Standalone Head40-533 model for the clear-only fuzzy-weight-0.0 run.

    Its topology intentionally matches the established Head40-533 baseline.
    The ablation changes only which samples enter the training loss.
    """
...
) -> ResNet18Head40TOMLDirectionUnifiedStem533AmbiguousWeight00:
    return ResNet18Head40TOMLDirectionUnifiedStem533AmbiguousWeight00(
...
def architecture_metadata() -> dict[str, object]:
    return {
        "model": "ResNet18Head40TOMLDirectionUnifiedStem533AmbiguousWeight00",
        "block": "BasicBlock3D",
        "layers": [2, 2, 2, 2],
        ...
        "experiment_implementation": "ambiguous_weight00_multiboard",
    }
