...
class ResNet18Head40TOMLDirectionUnifiedStem533Layer3E2(nn.Module):
    """Head40-533 with an HWAvg-k1-k3-DMax Layer3 auxiliary branch."""
    ...
    def __init__(self, num_classes: int = 2, dropout_rate: float = 0.5) -> None:
        ...
        self.layer3_depth_conv = nn.Conv1d(
            128,
            128,
            kernel_size=3,
            padding=1,
        ...
        self.layer3_depth_bn = nn.BatchNorm1d(128)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        layer3_aux = self.relu(
            self.layer3_depth_bn(self.layer3_depth_conv(layer3_aux))
        )
...
) -> ResNet18Head40TOMLDirectionUnifiedStem533Layer3E2:
    return ResNet18Head40TOMLDirectionUnifiedStem533Layer3E2(
...
def architecture_metadata() -> dict[str, object]:
    return {
        "model": "ResNet18Head40TOMLDirectionUnifiedStem533Layer3E2",
        "block": "BasicBlock3D",
        "layers": [2, 2, 2, 2],
        ...
        "classifier_pool": "Layer4_GAP_concat_Layer3_HWAvg_k1_k3_DMax",
        "classifier_pool_branches": ["Layer4_GAP", "Layer3_HWAvg_k1_k3_DMax"],
        "classifier_fusion": "concat",
        "classifier_feature_dim": 640,
        "layer4_feature_dim": 512,
        "layer3_aux_variant": "e2",
        "layer3_aux_input_channels": 256,
        "layer3_aux_projection_channels": 128,
        "layer3_aux_spatial_pool": ["average"],
        "layer3_aux_depth_conv_kernels": [3],
        "layer3_aux_depth_conv_channels": [128],
