...
class ResNet18Head40TOMLDirectionUnifiedStem533Layer3E3(nn.Module):
    """Head40-533 with an HWAvg-k1-multiscale35-DMax Layer3 branch."""
...
) -> ResNet18Head40TOMLDirectionUnifiedStem533Layer3E3:
    return ResNet18Head40TOMLDirectionUnifiedStem533Layer3E3(
...
def architecture_metadata() -> dict[str, object]:
    return {
        "model": "ResNet18Head40TOMLDirectionUnifiedStem533Layer3E3",
        "block": "BasicBlock3D",
        "layers": [2, 2, 2, 2],
        ...
        "classifier_pool": "Layer4_GAP_concat_Layer3_HWAvg_k1_k35_DMax",
        "classifier_pool_branches": ["Layer4_GAP", "Layer3_HWAvg_k1_k35_DMax"],
        "classifier_fusion": "concat",
        "classifier_feature_dim": 640,
        "layer4_feature_dim": 512,
        "layer3_aux_variant": "e3",
