...
class ResNet18Head40TOMLDirectionUnifiedStem533AmbiguousWeight05(nn.Module):
    """Standalone Head40-533 model for the fuzzy-weight-0.5 experiment.

    The network topology is intentionally identical to the established
    Head40-533 baseline.  Only the training loss changes for fuzzy samples.
    """
...
) -> ResNet18Head40TOMLDirectionUnifiedStem533AmbiguousWeight05:
    return ResNet18Head40TOMLDirectionUnifiedStem533AmbiguousWeight05(
...
def architecture_metadata() -> dict[str, object]:
    return {
        "model": "ResNet18Head40TOMLDirectionUnifiedStem533AmbiguousWeight05",
        "block": "BasicBlock3D",
        "layers": [2, 2, 2, 2],
        ...
        "experiment_implementation": "ambiguous_weight05_multiboard",
    }
