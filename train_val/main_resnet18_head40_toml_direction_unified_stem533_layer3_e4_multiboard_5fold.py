...
from model.resnet18_3d_head40_toml_direction_unified_stem533_layer3_e4_multiboard import (  # noqa: E402
    architecture_metadata,
    resnet18_3d,
)

EXPERIMENT_NAME = (
    "resnet18_head40_toml_direction_unified_stem533_layer3_e4_multiboard_22boards_5fold"
)
DEFAULT_SPLIT_ROOT = (
    PROJECT_ROOT
    / "datasets"
...
CHECKPOINT_FILES = {
    "best_f1": "best_f1_resnet18_head40_toml_direction_unified_stem533_layer3_e4.pth",
    "best_loss": "best_loss_resnet18_head40_toml_direction_unified_stem533_layer3_e4.pth",
    "last": "last_resnet18_head40_toml_direction_unified_stem533_layer3_e4.pth",
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Train Head40-533 Layer3 E4 (HWAvg/HWMax-k1-parallel-k3/k5-DMax "
            "plus Layer4 GAP) on the fixed 22-board five-fold manifests."
        )
    )
...
def main() -> None:
    ...
    print("=" * 100)
    print("Head40-533 Layer3 E4 HWAvgMax-k1-multiscale35-DMax: 22-board 5-fold CV")
    print(f"Folds: {folds}")
