...
def run_pipeline(fold_idx, seed, num_epochs=EPOCHS_PER_RUN):
    ...
    model_dir = str(MODEL_BEST_LAST_DIR / RESNET18_MULTI_SCALE_2_EXPERIMENT / f'fold_{fold_idx}')
    picture_dir = str(TRAIN_VAL_RESULT_DIR / RESNET18_MULTI_SCALE_2_EXPERIMENT / f'fold_{fold_idx}')
...
if __name__ == '__main__':
    ...
    summary_root = TRAIN_VAL_RESULT_DIR / RESNET18_MULTI_SCALE_2_EXPERIMENT
