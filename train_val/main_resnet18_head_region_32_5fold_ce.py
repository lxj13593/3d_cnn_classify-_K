...
from model.resnet_18_34_50_3d_head_region_32 import ResNet3D, BasicBlock
...
HEAD_REGION_DATA_5FOLD_DIR = (
    Path(__file__).resolve().parent.parent / "datasets" / "head_32" / "data_5fold"
)
HEAD_REGION_VOLUME_SHAPE = (32, 37, 37)
HEAD_REGION_EXPERIMENT = "resnet18_head_region_32_5fold_ce"
HEAD_REGION_MODEL_FILES = {
    "best_f1": "best_resnet18_head_region_32_3d.pth",
    "best_loss": "best_loss_resnet18_head_region_32_3d.pth",
    "last": "last_resnet18_head_region_32_3d.pth",
}
