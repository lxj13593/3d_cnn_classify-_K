...
EXPERIMENT_NAME = "resnet18_head40_toml_direction_unified_layer1_block1_conv1_acb_multiboard_22boards_5fold"
DEFAULT_SPLIT_ROOT = (
    PROJECT_ROOT
    / "datasets"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Train the TOML Head40 3D ResNet18 with a four-branch Planar ACB "
            "only at layer1[0].conv1, after standardizing every drill head to "
            "the high-D side and using the fixed 22-board five-fold split."
        )
    )
...
def main() -> None:
    ...
    print("=" * 100)
    print("TOML Head40 733 + layer1[0].conv1 Planar ACB: 22-board 5-fold CV")
    print(f"Folds: {folds}")
