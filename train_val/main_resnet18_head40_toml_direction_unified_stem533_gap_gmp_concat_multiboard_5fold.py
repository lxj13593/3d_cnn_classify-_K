...
from model.resnet18_3d_head40_toml_direction_unified_stem533_gap_gmp_concat_multiboard import (  # noqa: E402
    architecture_metadata,
    resnet18_3d,
)

EXPERIMENT_NAME = (
    "resnet18_head40_toml_direction_unified_stem533_gap_gmp_concat_multiboard_22boards_5fold"
)
DEFAULT_SPLIT_ROOT = (
    PROJECT_ROOT
    / "datasets"
...
CHECKPOINT_FILES = {
    "best_f1": "best_f1_resnet18_head40_toml_direction_unified_stem533_gap_gmp_concat.pth",
    "best_loss": "best_loss_resnet18_head40_toml_direction_unified_stem533_gap_gmp_concat.pth",
    "last": "last_resnet18_head40_toml_direction_unified_stem533_gap_gmp_concat.pth",
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Train Head40 Stem533 ResNet18 with concatenated GAP and GMP and an "
...
def main() -> None:
    ...
    print("=" * 100)
    print("Head40 Stem533 GAP+GMP Concat ResNet18: 22-board 5-fold CV")
    print(f"Folds: {folds}")
