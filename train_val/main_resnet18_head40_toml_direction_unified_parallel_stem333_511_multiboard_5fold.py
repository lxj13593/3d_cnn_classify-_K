...
from model.resnet18_3d_head40_toml_direction_unified_parallel_stem333_511_multiboard import (  # noqa: E402
    architecture_metadata,
    resnet18_3d,
)

EXPERIMENT_NAME = (
    "resnet18_head40_toml_direction_unified_parallel_stem333_511_multiboard_22boards_5fold"
)
DEFAULT_SPLIT_ROOT = (
    PROJECT_ROOT
    / "datasets"
...
CHECKPOINT_FILES = {
    "best_f1": "best_f1_resnet18_head40_toml_direction_unified_parallel_stem333_511.pth",
    "best_loss": "best_loss_resnet18_head40_toml_direction_unified_parallel_stem333_511.pth",
    "last": "last_resnet18_head40_toml_direction_unified_parallel_stem333_511.pth",
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "parallel 3x3x3 and 5x1x1 stem on the fixed 22-board five-fold "
            "manifests."
        )
    )
...
def main() -> None:
    ...
    print("=" * 100)
    print("Head40 Parallel-Stem333-511 ResNet18: 22-board 5-fold CV")
    print(f"Folds: {folds}")
