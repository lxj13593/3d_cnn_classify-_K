...
from model.resnet18_3d_head40_toml_direction_unified_stem533_layer2_stride122_multiboard import (  # noqa: E402
    architecture_metadata,
    resnet18_3d,
)

EXPERIMENT_NAME = (
    "resnet18_head40_toml_direction_unified_stem533_layer2_stride122_multiboard_22boards_5fold"
)
DEFAULT_SPLIT_ROOT = (
    PROJECT_ROOT
    / "datasets"
...
CHECKPOINT_FILES = {
    "best_f1": "best_f1_resnet18_head40_toml_direction_unified_stem533_layer2_stride122.pth",
    "best_loss": "best_loss_resnet18_head40_toml_direction_unified_stem533_layer2_stride122.pth",
    "last": "last_resnet18_head40_toml_direction_unified_stem533_layer2_stride122.pth",
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Train the TOML Head40 direction-unified 3D ResNet18 with an "
            "5x3x3 stem and layer2 stride (1,2,2) on the fixed 22-board "
            "five-fold manifests."
        )
    )
...
def main() -> None:
    ...
    print("=" * 100)
    print(
        "TOML Head40 Stem533 Layer2-Stride122 3D ResNet18: "
        "22-board 5-fold CV"
    )
    print(f"Folds: {folds}")
