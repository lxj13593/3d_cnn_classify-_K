...
from model.resnet_18_34_50_3d_head_region_24_keep_length import ResNet3D, BasicBlock
...
HEAD_REGION_DATA_5FOLD_DIR = (
    Path(__file__).resolve().parent.parent / "datasets" / "head_24" / "data_5fold"
)
HEAD_REGION_VOLUME_SHAPE = (24, 37, 37)
HEAD_REGION_EXPERIMENT = "resnet18_head_region_24_keep_length_5fold_ce"
HEAD_REGION_MODEL_FILES = {
    "best_f1": "best_resnet18_head_region_24_keep_length_3d.pth",
    "best_loss": "best_loss_resnet18_head_region_24_keep_length_3d.pth",
    "last": "last_resnet18_head_region_24_keep_length_3d.pth",
}
...
def run_pipeline(fold_idx, seed, num_epochs=EPOCHS_PER_RUN):
    ...
    # 使用 ResNet18；layer4仅下采样H/W，保留长度方向特征
    model = ResNet3D(
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print(
        f" 开始执行 ResNet18 + CE 头部24区域保留长度 5-fold 训练。fold seeds: {fold_seeds} | 单折: {EPOCHS_PER_RUN} 轮"
    )
    print("=" * 70)
