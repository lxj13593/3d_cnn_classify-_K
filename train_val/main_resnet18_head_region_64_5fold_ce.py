...
from model.resnet_18_34_50_3d_head_region_64 import ResNet3D, BasicBlock
...
HEAD_REGION_DATA_5FOLD_DIR = (
    Path(__file__).resolve().parent.parent / "datasets" / "head_64" / "data_5fold"
)
HEAD_REGION_VOLUME_SHAPE = (64, 37, 37)
HEAD_REGION_EXPERIMENT = "resnet18_head_region_64_5fold_ce"
HEAD_REGION_MODEL_FILES = {
    "best_f1": "best_resnet18_head_region_64_3d.pth",
    "best_loss": "best_loss_resnet18_head_region_64_3d.pth",
    "last": "last_resnet18_head_region_64_3d.pth",
}
