...
DEFAULT_OUTPUT_DIR = TEST_RESULT_DIR / "external_3boards_resnet18_all_checkpoints"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate the original full-volume ResNet18 on the three external "
            "boards using best-F1, best-loss and last checkpoints from each fold."
        )
    )
    parser.add_argument(
        "--data-root",
