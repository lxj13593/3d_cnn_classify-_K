...
MODEL_NAME = "resnet18_head37"
EXPERIMENT_NAME = "resnet18_head_region_37_5fold_ce"
CHECKPOINT_FILES = {
...
DEFAULT_OUTPUT_DIR = TEST_RESULT_DIR / "external_3boards_resnet18_head37_all_checkpoints"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate the head37 ResNet18 on the three external boards using "
            "best-F1, best-loss and last checkpoints from each fold."
        )
    )
    parser.add_argument(
        "--data-root",
