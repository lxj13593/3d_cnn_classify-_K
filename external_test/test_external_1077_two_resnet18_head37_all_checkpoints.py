...
DEFAULT_OUTPUT_DIR = (
    TEST_RESULT_DIR / "external_1077_two_resnet18_head37_all_checkpoints"
)
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate the head37 ResNet18 on external board 1077_two "
            "using best-F1, best-loss and last checkpoints from each fold."
        )
    )
    parser.add_argument(
        "--data-root",
