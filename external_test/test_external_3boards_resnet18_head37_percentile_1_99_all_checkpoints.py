...
MODEL_NAME = "resnet18_head37_percentile_1_99"
...
DEFAULT_OUTPUT_DIR = (
    TEST_RESULT_DIR
    / "external_3boards_resnet18_head37_percentile_1_99_all_checkpoints"
)
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate the per-sample P1/P99 head37 ResNet18 on the three external "
            "boards using best-F1, best-loss and last checkpoints."
        )
    )
    parser.add_argument(
        "--data-root",
...
def main():
    ...
    print("Testing only reads pre-cropped RAW files; no cropping occurs during testing.")
