...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate Head40 Stem533 GAP+GMP Concat models from all five "
...
def load_checkpoint_model(
    ...
    if (
        ...
        != "ResNet18Head40TOMLDirectionUnifiedStem533GAPGMPConcat"
        or model_metadata.get("stem_conv_kernel") != [5, 3, 3]
        or model_metadata.get("classifier_pool") != "GAP_concat_GMP"
        ...
        raise ValueError(
            f"Checkpoint is not the Head40 Stem533 GAP+GMP Concat model: {path}"
        )
...
def main() -> None:
    ...
    print("=" * 100)
    print("Head40 Stem533 GAP+GMP Concat ResNet18: locked three-board test")
