...
from data_operate.config import (
    ...
    RESNET18_CE_MICRO_DEFECT_SAFE_EXPERIMENT,
...
def main():
    ...
    for fold_idx, seed in enumerate(fold_seeds):
        ...
        for model_key, file_name in model_files.items():
            ...
            model_path = str(MODEL_BEST_LAST_DIR / RESNET18_CE_MICRO_DEFECT_SAFE_EXPERIMENT / f'fold_{fold_idx}' / file_name)
            save_dir = str(TEST_RESULT_DIR / RESNET18_CE_MICRO_DEFECT_SAFE_EXPERIMENT / f'fold_{fold_idx}' / model_key)
    ...
    if all_test_results:
        ...
        summary_root = str(TEST_RESULT_DIR / RESNET18_CE_MICRO_DEFECT_SAFE_EXPERIMENT)
