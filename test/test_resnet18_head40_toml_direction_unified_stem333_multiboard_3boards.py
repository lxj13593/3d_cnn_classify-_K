...
from model.resnet18_3d_head40_toml_direction_unified_stem333_multiboard import (  # noqa: E402
    resnet18_3d,
)


EXPERIMENT_NAME = (
    "resnet18_head40_toml_direction_unified_stem333_multiboard_22boards_5fold"
)
DEFAULT_SPLIT_ROOT = (
    PROJECT_ROOT
    / "datasets"
...
CHECKPOINT_FILES = {
    "best_f1": "best_f1_resnet18_head40_toml_direction_unified_stem333.pth",
    "best_loss": "best_loss_resnet18_head40_toml_direction_unified_stem333.pth",
    "last": "last_resnet18_head40_toml_direction_unified_stem333.pth",
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate all five TOML Head40 direction-unified ResNet18 Stem333 "
...
def load_checkpoint_model(
    ...
    if (
        ...
        != "ResNet18Head40TOMLDirectionUnifiedStem333"
        or model_metadata.get("stem_conv_kernel") != [3, 3, 3]
        or model_metadata.get("direction_standardized") is not True
        or model_metadata.get("standardized_head_side") != "high_depth_index"
    ):
        raise ValueError(
            f"Checkpoint is not the Head40 direction-unified Stem333 model: {path}"
        )
