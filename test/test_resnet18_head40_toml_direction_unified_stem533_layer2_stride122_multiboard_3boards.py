...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate all five Head40 Stem533 Layer2-Stride122 folds on the "
...
def main() -> None:
    ...
    print("=" * 100)
    print("Head40 Stem533 Layer2-Stride122 ResNet18: locked three-board test")
