...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate all five TOML Head40 direction-unified ResNet18 Stem533 "
...
def load_checkpoint_model(
    ...
    if (
        ...
        != "ResNet18Head40TOMLDirectionUnifiedStem533"
        ...
        raise ValueError(
            f"Checkpoint is not the Head40 direction-unified Stem533 model: {path}"
        )
...
def main() -> None:
    ...
    print("=" * 100)
    print("TOML Head40 direction-unified 3D ResNet18 Stem533: locked three-board test")
